...
return [
    ...
    |
    */
    'user_event_free_date'    => 'Пользователь :attribute занят в этот период времени.',
    'available_tag'     => 'Данный тег недоступен',
    'available_subject_by_id' => 'Данный предмет недоступен',
    'project_group_exists'   => 'Класс/группа с таким именем уже существует.',
    'project_group_by_id'     => 'Класс/группа не существует.',
    'tutorsubject'         => 'Выбранный предмет этому репетитору не доступен.',
    'numericarray'         => 'Поле :attribute должно быть цифровым массивом.',
